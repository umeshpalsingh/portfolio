    ...
    <section className="techstack" id="techstack">
            <div className="wrap">
                ...
                <div className="tech-grid">
                    <div className="tech-card reveal" style={{ "--skillPct": "90%" } as React.CSSProperties}>
                    ...
                    <div className="tech-card reveal" style={{ "--skillPct": "68%" } as React.CSSProperties}>
