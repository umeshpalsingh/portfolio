    ...
    <section className="connect" id="connect">
            <div className="wrap">
                ...
                <div className="social-row stagger">
                    <a href="mailto:hello@example.com" className="social-pill reveal" id="emailPill"
                    ...
                    <a href="https://instagram.com/yourhandle" className="social-pill reveal">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <a href="https://github.com/yourhandle" className="social-pill reveal">
                    ...
                    <a href="https://linkedin.com/in/yourhandle" className="social-pill reveal">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path
                    ...
                    <a href="https://x.com/yourhandle" className="social-pill reveal">
